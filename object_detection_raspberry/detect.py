# Script taken from https://github.com/tensorflow/examples.git
...
def run(model: str, camera_id: int, width: int, height: int, num_threads: int,
    ...
    # Alternative options (num_threads=x, label_allow_list=['string'], score_threshold=y, max_results=z)
    # Alternative options (label_allow_list=['person'], score_threshold=0.3, max_results=3)
